...
public class Main {
    public static void main(String[] args) {
        ...
        HashC<Integer, String> hash1 = new HashC<>(7);
        ...
        HashC<Integer, String> hash2 = new HashC<>(6);
        ...
        HashC<Integer, String> hash3 = new HashC<>(5);
        ...
        Register<Integer, String> found = hash3.search(20);
        System.out.println("Buscar clave 20: " + (found != null ? found : "No encontrada"));
        Register<Integer, String> notFound = hash3.search(30);
        ...
        HashC<Integer, String> hash4 = new HashC<>(7);
        ...
        Register<Integer, String> result = hash4.search(19);
